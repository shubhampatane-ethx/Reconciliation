...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = mode === 'login'
      ...
      : await register(trimUser, trimPass);
    setSubmitting(false);
  ...
  return (
    <div className="auth-shell">
        ...
        <div className="auth-showcase">
          <div className="auth-showcase-inner">
            ...
            <div className="auth-quote">
              <p>“Cut our month-end reconciliation time by 80%.”</p>
              <div className="auth-quote-author">
                <div className="auth-quote-avatar">M</div>
                <div>
                  <div className="auth-quote-name">Michael Chen</div>
                  <div className="auth-quote-role">Financial Controller</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="auth-form-side">
          <div className="auth-card">
            ...
            <form onSubmit={handleSubmit} className="auth-form" autoComplete="on">
              <label className={`auth-field ${focusedField === 'username' ? 'is-focused' : ''}`}>
      ...
      <style>{`
        ...
        .auth-quote p { margin: 0 0 1rem; font-size: 1rem; color: #e8edf9; font-style: italic; line-height: 1.5; }
        ...
        .auth-quote-name { font-weight: 700; color: #fff; font-size: 0.88rem; }
        .auth-quote-role { color: #94a3b8; font-size: 0.78rem; }
