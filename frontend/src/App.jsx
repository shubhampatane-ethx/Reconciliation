...
function App() {
  ...
  // Opens the floating chat widget with the current report attached as
  // context and an initial question pre-sent — the widget itself owns the
  // actual conversation from there.
  const askAboutReport = (report, insights) => {
    setChatSeed({
      text: 'Explain this reconciliation report in business language.',
      context: { report, insights },
      nonce: Date.now(),
    });
  };
            ...
            <div className="insights-panel">
              ...
              <div className="ai-explain-panel">
                <button
                  type="button"
                  className="secondary"
                  onClick={() => askAboutReport(report, insights)}
                >
  ...
  return (
    <div className="app-shell">
      ...
      <ChatWidget apiBase={API_BASE} seed={chatSeed} />
    </div>
  );
}
