...
def create_series(name: str, filename: str, df, user_id=None, data_type: str = "master") -> Dict:
...
def list_series() -> List[Dict]:
    ...
    for s in all_series.values():
        ...
        result.append({
            ...
            "data_type": s.get("data_type", "master"),
...
def add_series_version(series_id: str, filename: str, df, key_columns: List[str],
                        diff_summary: Dict, report_file: str, label: str = None,
                        data_type: str = "master") -> Dict:
